...
public class StoredProc extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../../StoredProc.fxml"));
            primaryStage.setTitle("SDA Demo");
            primaryStage.setScene(new Scene(loader.load(), 630, 440));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            connection = DriverManager.getConnection("jdbc:mysql://localhost/StudentsDemo?characterEncoding=latin1", "root", "root");
